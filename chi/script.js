...
document.getElementById('siBtn').addEventListener('click', function() {
    ...
    document.getElementById('messageContainer').innerHTML = '¡sabia que dirias si gracias Isa <3!';
...
document.getElementById('noBtn').addEventListener('click', function() {
    switch (noButtonState) {
        ...
        case 16:
            ...
            document.getElementById('noBtn').innerHTML = 'di que siiiiiiiii';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 17:
            ...
            document.getElementById('noBtn').innerHTML = 'mi corazon se rompe isa';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 18:
            ...
            document.getElementById('noBtn').innerHTML = 'isa porfavor';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 19:
            ...
            document.getElementById('noBtn').innerHTML = 'isaaaaaaaaaaaaaa';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';

            // Hacer que el botón "Sí" crezca
            document.getElementById('siBtn').style.fontSize = '280px';
            document.getElementById('siBtn').style.padding = '210px 320px';
          
            noButtonState++;
            break;
        case 20:
           
            document.getElementById('noBtn').innerHTML = 'que te cuestaaaaaaa';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 21:
            ...
            document.getElementById('noBtn').innerHTML = 'porfavooooooooor';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 22:
            ...
            document.getElementById('noBtn').innerHTML = 'el boton esta alado';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
